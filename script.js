    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "צ'יק צ'ק משלוחים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7c99466b-f515-4ca0-9aff-ecfbe00cda95',
                    name: data.name || '',
                    email: data.email || '',
